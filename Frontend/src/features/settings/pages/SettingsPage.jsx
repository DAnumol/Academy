...
import { useState } from 'react'
import { motion, AnimatePresence } from 'framer-motion'
import { User, Bell, Shield, Palette, Globe, Camera, Save } from 'lucide-react'
import { Button } from '@components/ui/Button'
import { Input } from '@components/ui/Input'
import { useTheme } from '@hooks/useTheme'
import toast from 'react-hot-toast'
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="p-6 rounded-xl bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-semibold text-blue-900 dark:text-blue-100">Advanced Customization</h3>
                  <p className="text-sm text-blue-700 dark:text-blue-300">Customize colors, typography, and layout</p>
                </div>
                <Button onClick={() => setShowThemeCustomizer(true)} className="bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600">
