...
import { attendanceTableConfig } from '../../../config/tableConfigs'
import { attendanceFormConfig } from '../../../config/formConfigs'
...
const AttendanceTable = () => {
  ...
  const { useList, useCreate, useUpdate, useDelete } = useGenericCRUD({
    queryKey: 'attendance',
    service: {
      getAll: attendanceService.getAll,
  ...
  return (
    <>
      <GenericDataTable
        data={attendance}
        columns={attendanceTableConfig.columns}
        title={attendanceTableConfig.title}
        description={attendanceTableConfig.description}
        isLoading={isLoading}
        error={error}
        onRefetch={refetch}
        ...
        searchFields={attendanceTableConfig.searchFields}
        filterConfig={attendanceTableConfig.filterConfig}
        statusField={attendanceTableConfig.statusField}
      ...
      <GenericFormModal
        ...
        title={showEditModal ? 'Edit Attendance' : attendanceFormConfig.title}
        fields={attendanceFormConfig.fields}
